    ...
    common: [
        {
            templates: [
                ...
                'app/shared/components/form/jhi-switch-input.js',
                'app/shared/components/form/jhi-text-input.js',
                ...
                { file: 'app/shared/images/logo-jhipster-drink-coffee.png', method: 'copy' },
                { file: 'app/shared/images/logo-jhipster-drink-coffee@2x.png', method: 'copy' },
                { file: 'app/shared/images/logo-jhipster-drink-coffee@3x.png', method: 'copy' },
                ...
                { file: 'app/shared/images/logo-login.png', method: 'copy' },
                { file: 'app/shared/images/logo-login@2x.png', method: 'copy' },
                { file: 'app/shared/images/logo-login@3x.png', method: 'copy' },
                { file: 'app/shared/images/top-logo.png', method: 'copy' },
                { file: 'app/shared/images/top-logo@2x.png', method: 'copy' },
                { file: 'app/shared/images/top-logo@3x.png', method: 'copy' },
                { file: 'app/shared/images/your-app.png', method: 'copy' },
                { file: 'app/shared/images/your-app@2x.png', method: 'copy' },
