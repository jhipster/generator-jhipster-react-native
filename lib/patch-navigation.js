...
function patchNavigationForEntity(name) {
    ...
    const entityScreenButton = `        <RoundedButton text="${this.context.entityNameCapitalized}" onPress={() => this.props.navigation.navigate('${this.context.entityNameCapitalized}')} testID="${this.context.entityInstance}EntityScreenButton" />`;
