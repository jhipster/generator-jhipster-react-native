function patchEntityApi() {
  ...
  delete${this.context.entityNameCapitalized}: (${this.context.entityInstance}Id) => {
    ...
    let sagaConnections = `
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_REQUEST, ${this.context.entityNameCapitalized}Sagas.get${
        this.context.entityNameCapitalized
    }, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_ALL_REQUEST, ${this.context.entityNameCapitalized}Sagas.getAll${
        this.context.entityNamePlural
    }, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_UPDATE_REQUEST, ${this.context.entityNameCapitalized}Sagas.update${
        this.context.entityNameCapitalized
    }, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_DELETE_REQUEST, ${this.context.entityNameCapitalized}Sagas.delete${
        this.context.entityNameCapitalized
    }, api),`;
  ...
  search${this.context.entityNamePlural}: (query) => {
    ...
    search${this.context.entityNamePlural},`;
        sagaConnections += `
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_SEARCH_REQUEST, ${this.context.entityNameCapitalized}Sagas.search${
            this.context.entityNamePlural
        }, api),`;
    }
