function patchEntityApi() {
  ...
  const updateMethod = this.context.useOldPutMappingCode
    ...
    : `const update${this.context.entityNameCapitalized} = (${this.context.entityInstance}) => api.put(\`${microservicePath}api/${this.context.entityApiUrl}/\${${this.context.entityInstance}.id}\`, ${this.context.entityInstance});`;
  ...
  let sagaConnections = `
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityNameSnakeCase.toUpperCase()}_REQUEST, ${
    this.context.entityNameCapitalized
  }Sagas.get${this.context.entityNameCapitalized}, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityNameSnakeCase.toUpperCase()}_ALL_REQUEST, ${
    this.context.entityNameCapitalized
  }Sagas.getAll${this.context.entityNamePlural}, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityNameSnakeCase.toUpperCase()}_UPDATE_REQUEST, ${
    this.context.entityNameCapitalized
  }Sagas.update${this.context.entityNameCapitalized}, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityNameSnakeCase.toUpperCase()}_DELETE_REQUEST, ${
    this.context.entityNameCapitalized
  }Sagas.delete${this.context.entityNameCapitalized}, api),`;
  ...
  search${this.context.entityNamePlural}: (query) => {
    ...
    sagaConnections += `
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityNameSnakeCase.toUpperCase()}_SEARCH_REQUEST, ${
      this.context.entityNameCapitalized
    }Sagas.search${this.context.entityNamePlural}, api),`;
  }
