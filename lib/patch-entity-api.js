function patchEntityApi() {
  ...
  delete${this.context.entityNameCapitalized}: (${this.context.entityInstance}Id) => {
    ...
    let sagaConnections = `
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_REQUEST, get${
        this.context.entityNameCapitalized
    }, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_ALL_REQUEST, get${
        this.context.entityNamePlural
    }, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_UPDATE_REQUEST, update${
        this.context.entityNameCapitalized
    }, api),
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_DELETE_REQUEST, delete${
        this.context.entityNameCapitalized
    }, api),`;
  ...
  search${this.context.entityNamePlural}: (query) => {
    ...
    search${this.context.entityNamePlural},`;
        sagaConnections += `
    takeLatest(${this.context.entityNameCapitalized}Types.${this.context.entityTableName.toUpperCase()}_SEARCH_REQUEST, search${
            this.context.entityNamePlural
        }, api),`;
    }
    ...
    this.patchInFile(sagaIndexFilePath, {
        ...
        insert: `import { get${this.context.entityNameCapitalized}, get${this.context.entityNamePlural}, update${
            this.context.entityNameCapitalized
        }, delete${this.context.entityNameCapitalized}${
